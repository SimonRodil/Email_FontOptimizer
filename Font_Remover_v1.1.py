...
def collect_inherited_italic_triplets_in_html(html_text):
    """
    Heurística simple: si encontramos estilos inline con font-style: italic
    pero sin font-family, asumimos que usan la última font-family encontrada
    previamente en el HTML (en orden de aparición).
    """
    used = set()
...
def main():
    ...
    inherited_italic_html = collect_inherited_italic_triplets_in_html(html_text)
    ...
    used_triplets = used_html | used_css | inherited_italic_html
